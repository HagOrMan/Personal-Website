...
![FIGI Hierarchy Example](/blog/intro-to-stock-symbology/FIGI_Hierarchy_Example.jpg)
...
- [Apple on NYSE](https://www.openfigi.com/search?marketSector=Equity&searchTerms=apple&securityType=Common+Stock&currency=USD&exchangeCode=UN&countryOfIssue=US), searched through OpenFIGI, a web portal to access all important FIGI information. Shows Apple's FIGI for its NYSE listing.
