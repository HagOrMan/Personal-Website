...
export default function Home() {
  return (
    <div className='grid grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 bg-background p-8 pb-20 font-(family-name:--font-geist-sans) sm:p-20'>
      <main className='row-start-2 flex flex-col items-center gap-8 sm:items-start'>
        <h1 className='text-4xl font-bold tracking-wide text-primary-rgb-700'>
          Hey! I&apos;m Kyle
        </h1>
