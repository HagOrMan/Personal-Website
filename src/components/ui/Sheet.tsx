  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          // Asymmetric on purpose: you watch a panel arrive, but you want it
          // gone the moment you've decided. 500ms in (the shadcn default) read
          // as sluggish for something you open in order to use.
